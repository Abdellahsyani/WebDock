...
WebDock is a containerized hosting platform that runs multiple web services using Docker and Docker Compose.  
...
## Architecture
At a high level, WebDock relies on:
...
```bash
# 1) Clone
git clone https://github.com/Abdellahsyani/WebDock.git
cd WebDock
